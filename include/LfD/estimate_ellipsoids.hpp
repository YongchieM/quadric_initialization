...
void estimate_ellipsoid(eigMatrix& Ps_t, Eigen::Vector3d& input_ellipsoids_centres, eigMatrix& inputCs, Eigen::Matrix4d& estQ);
...
void compute_estimates(eigMatrix& bbs, const Eigen::Matrix3d K, eigMatrix& Ms_t, eigMatrix& inputCs, eigMatrix& estCs, Eigen::Matrix4d& estQs_second_step);
